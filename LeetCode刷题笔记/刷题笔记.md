        ...
        */
        ...
        for(int i = 0; i < puzzles.length; i++){
            ...
            do{
                ...
                //因为还会 或 puzzle的第一位，所以相当于遍历剩下6位 所有的子序列
                //最多需要遍历2^7=128次，
                sub = (sub - 1) & mask;
...
n&（n-1）恰好会把n的最后一位1减为0，随后和(n-1)进行&运算，随后一位“1”就没了，res++
...
> n为传入的int数，那么其二进制表达方式的长度为log2(n)。假设2^x = n，x就表示二进制的位数，n的二进制就是1000000...
